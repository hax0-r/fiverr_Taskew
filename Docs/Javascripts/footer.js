...
footer.innerHTML = `
    <footer class="max-w-[1485px] md:mt-20 mt-10 w-full mx-auto md:rounded-3xl bg-[#0c1524] md:p-10 p-5 pt-12 md:mb-8">
            ...
            <div class="flex md:flex-row flex-col flex-wrap md:gap-20 gap-8 md:mt-0 mt-6">
                ...
                <div class="">
                    ...
                    <ul class="md:mt-6 mt-4 text-white opacity-80 space-y-2">
                        <li><a class="hover:text-[#ff8159] transition-all duration-500" href="">Book appointment</a></li>
                ...
                <div class="">
                    ...
                    <ul class="mt-6 text-white opacity-80 flex gap-2">
                        <li><a class="hover:text-[#ff8159] hover:bg-white transition-all text-white w-10 h-10 flex items-center justify-center rounded-full bg-[#ff8159]  duration-500" href="">
